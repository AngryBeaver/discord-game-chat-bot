...
public class Gaia implements Game {
    ...
    @GameMethod
    public GameResult mightGaiaDown(GameData gameData) {
        UserEntity userEntity = users.get(gameData.getUserId());
        userEntity.setBrainstone1(userEntity.getBrainstone1() + userEntity.getBrainstone0());
        if (userEntity.getAvatar() == "terraner") {
            userEntity.setMight2(userEntity.getMight2() + userEntity.getMight0());
        } else {
            userEntity.setMight1(userEntity.getMight1() + userEntity.getMight0());
        }
        userEntity.setBrainstone0(0);
        userEntity.setMight0(0);
        return new GameResult()
                .addEvent(EVENT_USER)
                .set(MAP_KEY_USER, userEntity);
    }
    ...
    @GameMethod
    public GameResult mightUp(GameData gameData) {
        UserEntity userEntity = users.get(gameData.getUserId());
        if (userEntity.getBrainstone1() > 0) {
            userEntity.setBrainstone1(0);
            userEntity.setBrainstone2(1);
        } else if (userEntity.getMight1() > 0) {
            userEntity.setMight1(userEntity.getMight1() - 1);
            userEntity.setMight2(userEntity.getMight2() + 1);
        } else if (userEntity.getBrainstone2() > 0) {
            userEntity.setBrainstone2(0);
            userEntity.setBrainstone3(1);
        } else if (userEntity.getMight2() > 0) {
            userEntity.setMight2(userEntity.getMight2() - 1);
            userEntity.setMight3(userEntity.getMight3() + 1);
        }
        return new GameResult()
    ...
    @GameMethod
    public GameResult mightUse(GameData gameData) {
        UserEntity userEntity = users.get(gameData.getUserId());
        if (userEntity.getBrainstone3() > 0) {
            userEntity.setBrainstone3(0);
            userEntity.setBrainstone1(1);
        } else if (userEntity.getMight3() > 0) {
            userEntity.setMight3(userEntity.getMight3() - 1);
            userEntity.setMight1(userEntity.getMight1() + 1);
        }
        return new GameResult()
